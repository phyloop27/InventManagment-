...
public class DatabaseMetaData implements java.sql.DatabaseMetaData {
    ...
    /** The ConnectionDB to the database */
    ...
    protected java.sql.ResultSet getProcedureOrFunctionColumns(Field[] fields, String catalog, String schemaPattern, String procedureOrFunctionNamePattern,
        ...
        try {
            ...
            if (!hasResults) {
                ...
                // "stored procedure parameter types. If rights can not be granted, configure ConnectionDB with \"noAccessToProcedureBodies=true\" " +
