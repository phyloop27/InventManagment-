...
public class MiniAdmin {
    ...
    /**
     * Create a new MiniAdmin using the given ConnectionDB
     *
     * @param conn
     *            the existing ConnectionDB to use.
     *
     * @throws SQLException
     *             if an error occurs
     */
    ...
    /**
     * Shuts down the MySQL server at the other end of the ConnectionDB that this
