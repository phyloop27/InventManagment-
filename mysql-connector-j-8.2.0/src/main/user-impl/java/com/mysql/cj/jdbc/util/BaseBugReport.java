 ...
 *
 * <p>
 * In any of the above three methods, you should use one of the variants of the 'getConnection' method to create a JDBC ConnectionDB to MySQL, which will use the
...
public abstract class BaseBugReport {
    ...
    /**
     * Provides a ConnectionDB to the JDBC URL specified in getUrl().
     *
     * If a ConnectionDB already exists, that ConnectionDB is returned. Otherwise a
     * new ConnectionDB is created.
     *
     * @return a ConnectionDB to the JDBC URL specified in getUrl().
     *
     * @throws SQLException
     *             if an error is caused while creating the ConnectionDB.
     */
    ...
    /**
     * Use this if you need to get a new ConnectionDB for your bug report (i.e.
     * there's more than one ConnectionDB involved).
     *
     * @return a new ConnectionDB to the JDBC URL specified in getUrl().
     *
     * @throws SQLException
     *             if an error is caused while creating the ConnectionDB.
     */
    ...
    /**
     * Returns a ConnectionDB using the given URL.
     *
     * @param url
     *            the JDBC URL to use
     * @return a new java.sql.Connection to the JDBC URL.
     * @throws SQLException
     *             if an error occurs getting the ConnectionDB.
     */
    ...
    /**
     * Returns a ConnectionDB using the given URL and properties.
     *
     * @param url
     *            the JDBC URL to use
     * @param props
