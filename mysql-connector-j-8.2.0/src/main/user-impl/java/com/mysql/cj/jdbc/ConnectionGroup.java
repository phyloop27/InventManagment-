...
public class ConnectionGroup {
    ...
    public long getTotalTransactionCount() {
        // need to account for closed ConnectionDB proxies
     ...
     *            If true instructs the load-balanced connections to fail-over the underlying active ConnectionDB before removing this host, otherwise remove
     *            immediately.
     * @throws SQLException
     *             if a database access error occurs
     */
