...
/**
 * A JNDI DataSource for a Mysql JDBC ConnectionDB
 */
public class MysqlDataSource extends JdbcPropertySetImpl implements DataSource, Referenceable, Serializable, JdbcPropertySet {
    ...
    /**
     * Sets the URL for this ConnectionDB
     *
     * @param url
     *            the URL for this ConnectionDB
     */
    ...
    /**
     * Returns the URL for this ConnectionDB
     *
     * @return the URL for this ConnectionDB
     */
    ...
    /**
     * Returns the JDBC URL that will be used to create the database ConnectionDB.
     *
     * @return the URL for this ConnectionDB
     */
    public String getUrl() {
    ...
    /**
     * Returns the configured user for this ConnectionDB
     *
     * @return the user for this ConnectionDB
     */
    ...
    /**
     * Creates a ConnectionDB using the specified properties.
     *
     * @param props
     *            the properties to connect with
     *
     * @return a ConnectionDB to the database
     *
     * @throws SQLException
     *             if an error occurs
     */
