 ...
 *
 * One instance of a strategy *per* JDBC ConnectionDB instance will be created. If you need singleton-like behavior, you're on your own to provide it.
 */
public interface BalanceStrategy {

    /**
     * Called by the driver to pick a new ConnectionDB to route requests over.
     ...
     *            the JDBC ConnectionDB, and serves as a factory for new
     ...
     *            ConnectionDB attempts if creating a new ConnectionDB fails.
     * @return the physical JDBC ConnectionDB for the application to use, based
     *         upon the strategy employed.
     * @throws SQLException
     *             if a new ConnectionDB can not be found or created by this
     *             strategy.
     */
