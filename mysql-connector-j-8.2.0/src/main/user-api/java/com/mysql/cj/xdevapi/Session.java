...
/**
 * X DevAPI introduces a new, high-level database ConnectionDB concept that is called Session. When working with X DevAPI it is important to understand this new
 ...
 * accordance to the settings of the current ConnectionDB.
...
public interface Session {
    ...
    /**
     * Retrieve the default schema name, which might have been configured at the time of ConnectionDB. Returns empty String if no default schema has been set.
     *
    ...
    /**
     * Retrieve the default schema name, which might have been configured at the time of ConnectionDB. Returns <code>null</code> if no default schema has been
     * set.
     *
