 ...
 *
 * {@link Client} objects provide the means of creating {@link Session}s that use an internally managed ConnectionDB pool.
 *
 * <pre>
...
public class ClientFactory {
     ...
     *            JSON string representing a document that defines ConnectionDB properties in a special format.
     ...
     *            the session URL.
     * @param clientProps
     *            the {@link Properties} instance that contains the ConnectionDB properties. The keys in this {@link Properties} match with the path of each value
