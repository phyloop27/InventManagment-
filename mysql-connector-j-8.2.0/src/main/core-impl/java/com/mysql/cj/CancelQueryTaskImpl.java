        ...
        Thread cancelThread = new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    // Case when ConnectionDB closed while starting to cancel.
                    // We can't easily synchronize this, because then one thread can't cancel() a running query.
                    // Ignore, we shouldn't re-throw this, because the ConnectionDB's already closed, so the statement has been timed out.
                } catch (Throwable t) {
