...
public class LoadBalanceConnectionUrl extends ConnectionUrl {
    ...
    /**
     * Constructs an instance of {@link LoadBalanceConnectionUrl}, performing all the required initializations and validations. A load-balanced ConnectionDB
    ...
    /**
     * Constructs an instance of a {@link LoadBalanceConnectionUrl} based on a list of hosts and a global set of properties instead of ConnectionDB string
     * parsing.
     * {@link ConnectionUrl} instances created by this process are not cached.
     *
     * @param hosts
     *            the hosts list to use in this ConnectionDB URL
     * @param properties
    ...
    /**
     * Injects additional properties into the ConnectionDB arguments while it's being constructed.
     *
     * @param props
    ...
    /**
     * Returns a list of this ConnectionDB URL hosts in the form of host:port pairs.
     *
     * @return a list of this ConnectionDB URL hosts in the form of host:port pairs
     */
