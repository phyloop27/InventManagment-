...
public class StandardSocketFactory implements SocketFactory {
    ...
    /**
     * Configures socket properties based on properties from the ConnectionDB
    ...
    public <T extends Closeable> T connect(String hostname, int portNumber, PropertySet pset, int loginTimeout) throws IOException {
        ...
        if (pset != null) {
            ...
            if (this.host != null) {
                ...
                // save last exception to propagate to caller if ConnectionDB fails
    ...
    /**
     * Validates the ConnectionDB/socket timeout that must really be used.
     *
