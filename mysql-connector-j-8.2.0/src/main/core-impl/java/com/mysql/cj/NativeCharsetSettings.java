...
public class NativeCharsetSettings extends CharsetMapping implements CharsetSettings {
    ...
    /**
     * Does the character set of this ConnectionDB match the character set of the platform
     */
    ...
    /**
     * Determines if the ConnectionDB charset is the same as the platform charset
     */
     ...
     *            ConnectionDB property containing the Java encoding to try
     * @param replaceImpermissibleEncodings
     *            The character_set_client system variable cannot be set to ucs2, utf16, utf16le, utf32 charsets. If "true" the corresponding ConnectionDB
    ...
    public void configurePostHandshake(boolean dontCheckServerMatch) {
         ...
         * transformed to backslash (0x5c) in the ConnectionDB encoding.
         */
        try {
