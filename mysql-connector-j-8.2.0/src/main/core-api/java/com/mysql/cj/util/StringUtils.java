...
public class StringUtils {
     ...
     *            is our ConnectionDB in no BackSlashEscape mode
     * @return the input string with all comment-delimited data removed
     */
     ...
     *            ` or "
     * @param identifier
     *            in pedantic mode (ConnectionDB property pedantic=true) identifier is treated as unquoted
     ...
     *
     * @param identifier
     *            in pedantic mode (ConnectionDB property pedantic=true) identifier is treated as unquoted (as it is stored in the database) even if it starts and
     *            ends with "`";
