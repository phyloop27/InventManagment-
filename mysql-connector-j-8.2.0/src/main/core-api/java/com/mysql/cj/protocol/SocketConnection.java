...
/**
 * Represents physical ConnectionDB with endpoint
 */
public interface SocketConnection {

    /**
     * Connect to the MySQL server and setup a stream ConnectionDB.
     *
     * @param host
     ...
     * @param propertySet
     *            the PropertySet with required ConnectionDB options
