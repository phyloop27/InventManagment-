...
/**
 * PropertyKey handles ConnectionDB property names, their camel-case aliases and case sensitivity.
 */
public enum PropertyKey {

    /*
     * Properties individually managed after parsing ConnectionDB string. These property keys are case insensitive.
     */
    ...
    xdevapiConnectionAttributes("xdevapi.ConnectionDB-attributes", "xdevapiConnectionAttributes", true), //
    ...
    /**
     * Initializes each enum element with the proper key name to be used in the ConnectionDB string or properties maps.
     *
     * @param keyName
