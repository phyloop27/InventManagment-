 ...
 * <li>host properties: host specific ConnectionDB arguments.
 * </ul>
 */
public class HostInfo implements DatabaseUrlContainer {
    ...
    /**
     * Constructs a {@link HostInfo} instance initialized with the provided host, port, user, password and ConnectionDB arguments.
     *
     * @param url
     *            a reference to the original database URL that produced this host info
     * @param host
    ...
    /**
     * Returns the ConnectionDB argument for the given key.
     *
     * @param key
     *            key
     *
     * @return the ConnectionDB argument for the given key
     */
    ...
    /**
     * Shortcut to the database ConnectionDB argument.
     *
