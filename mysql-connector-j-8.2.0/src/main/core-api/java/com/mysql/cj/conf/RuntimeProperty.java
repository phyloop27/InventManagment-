...
public interface RuntimeProperty<T> {
     ...
     *
     * @param extractFrom
     *            {@link Properties} object containing key-value pairs usually passed from ConnectionDB string.
    ...
    /**
     * Reset to initial value (default or defined in ConnectionDB string/Properties)
     */
    void resetValue();
    ...
    /**
     * Get initial value (default or defined in ConnectionDB string/Properties)
     *
     * @return value
     */
    T getInitialValue();
