...
public class CharsetMapping {
     ...
     * for this mapping then javaEncoding value as is; this is required when result should match to ConnectionDB encoding, for example if ConnectionDB encoding is
