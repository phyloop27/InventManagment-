...
public interface AuthenticationPlugin<M extends Message> {
    ...
    /**
     * Called by the driver when this extension should release any resources it is holding and cleanup internally before the ConnectionDB is closed.
     */
    ...
    /**
     * Does this plugin require the ConnectionDB itself to be confidential (i.e. tls/ssl)...Highly recommended to return "true" for plugins that return the
     * credentials in the clear.
     *
     * @return true if secure ConnectionDB is required
     */
     ...
     *
     * Plugin should use these values instead of values from ConnectionDB properties because parent method may be a changeUser call which saves user and password
     * into ConnectionDB only after successful handshake.
     *
     * @param user
     *            user name
     * @param password
     ...
     * limit or an OK packet is sent by server indicating that the ConnectionDB has been approved.
     *
