...
/**
 * A container for a database URL and a collection of given ConnectionDB arguments.
 * The ConnectionDB string is parsed and split by its components, each of which is then processed and fixed according to the needs of the ConnectionDB type.
 * This abstract class holds all common behavior to all ConnectionDB string types. Its subclasses must implement their own specifics such as classifying hosts by
...
public abstract class ConnectionUrl implements DatabaseUrlContainer {
    ...
    /**
     * The database URL type which is determined by the scheme section of the ConnectionDB string.
     */
    public enum Type {
        ...
        /**
         * Instantiates a class that implements the right type of ConnectionDB URLs for the given {@link ConnectionUrlParser}.
         *
         * @param parser
         *            the {@link ConnectionUrlParser} containing the URL components.
         * @param info
         *            a ConnectionDB properties map to add to the {@link ConnectionUrl} structure.
         * @return
        ...
        public static ConnectionUrl getConnectionUrlInstance(ConnectionUrlParser parser, Properties info) {
            ...
            if (dnsSrvPropKey != null && type.getAlternateDnsSrvType() != null) {
                if (info != null && info.containsKey(dnsSrvPropKey.getKeyName())) { // Properties map prevails over ConnectionDB string options.
        ...
        /**
         * Checks if the given scheme corresponds to one of the ConnectionDB types the driver supports.
         *
         * @param scheme
         *            scheme part from ConnectionDB string, like "jdbc:mysql:"
        ...
        /**
         * Instantiates a class that implements this type of ConnectionDB URLs with the given arguments.
         *
         * @param parser
         *            the {@link ConnectionUrlParser} containing the URL components.
         * @param info
     ...
     * Returns "null" it can't handle the ConnectionDB string.
     *
     * @param connString
     *            the ConnectionDB string
     * @param info
     *            the ConnectionDB arguments map
     * @return an instance of a {@link ConnectionUrl} or "null" if isn't able to handle the ConnectionDB string
     */
    ...
    /**
     * Builds a ConnectionDB URL cache map key based on the ConnectionDB string itself plus the string representation of the given ConnectionDB properties.
     *
     * @param connString
     *            the ConnectionDB string
     * @param info
     *            the ConnectionDB arguments map
     * @return a ConnectionDB string cache map key
     */
     ...
     *
     * @param connStrParser
     *            a {@link ConnectionUrlParser} instance containing the parsed version of the original ConnectionDB string
     * @param info
     *            the ConnectionDB arguments map
     */
    ...
    /**
     * Joins the ConnectionDB arguments from the ConnectionDB string with the ones from the given ConnectionDB arguments map collecting them in a single map.
     * Additionally may also collect other ConnectionDB arguments from configuration files.
     *
     * @param connStrParser
    ...
    /**
     * Expands the ConnectionDB argument "useConfig" by reading the mentioned configuration files.
     *
     * @param props
     *            a ConnectionDB arguments map from where to read the "useConfig" property and where to save the loaded properties.
     */
    ...
    /**
     * Subclasses must override this method if they need to inject additional properties in the ConnectionDB arguments map while it's being constructed.
     *
     * @param props
     *            the properties already containing all known ConnectionDB arguments
     */
     ...
     * Applies properties transformations to the collected properties if {@link ConnectionPropertiesTransform} was declared in the ConnectionDB arguments.
     *
     * @param hi
    ...
    protected HostInfo fixHostInfo(HostInfo hi) {
        ...
        // Add global ConnectionDB arguments.
        hostProps.putAll(this.properties);
        // Add/override host specific ConnectionDB arguments.
    ...
    /**
     * Returns the default user. Usually the one provided in the method {@link DriverManager#getConnection(String, String, String)} or as ConnectionDB argument.
     *
    ...
    /**
     * Returns the default password. Usually the one provided in the method {@link DriverManager#getConnection(String, String, String)} or as ConnectionDB
     * argument.
     *
    ...
    /**
     * Returns this ConnectionDB URL type.
     *
     * @return the ConnectionDB URL type
     */
    public Type getType() {
        return this.type;
    }
    ...
    /**
     * Returns the original database URL that produced this ConnectionDB string.
     *
    ...
    /**
     * Returns the database from this ConnectionDB URL. Note that a "DBNAME" property overrides the database identified in the ConnectionDB string.
     *
    ...
    /**
     * Returns the number of hosts in this ConnectionDB URL.
     *
    ...
    /**
     * Returns a list of the hosts in this ConnectionDB URL.
     *
     * @return the hosts list from this ConnectionDB URL
     */
    ...
    /**
     * Returns a list of the hosts in this ConnectionDB URL, filtered for the given view.
     *
     ...
     * @return
     *         the hosts list from this ConnectionDB URL, filtered for the given view.
     */
    ...
    /**
     * Returns an existing host info with the same host:port part or spawns a new isolated host info based on this ConnectionDB URL if none was found.
     *
     * @param hostPortPair
    ...
    /**
     * Creates a new {@link HostInfo} structure with the given components, passing through the properties transformer if there is one defined in this ConnectionDB
     * string;
     *
     * @param host
     *            the host
    ...
    /**
     * Returns the original (common to all hosts) ConnectionDB arguments as provided in the ConnectionDB string query section.
     *
     * @return the original (common to all hosts) ConnectionDB arguments
     */
    ...
    /**
     * Returns a {@link Properties} instance containing the ConnectionDB arguments extracted from the URL query section, i.e., per host attributes are excluded.
     * Applies properties transformations to the collected properties if {@link ConnectionPropertiesTransform} was declared in the ConnectionDB arguments.
     *
     * @return a {@link Properties} instance containing the common ConnectionDB arguments.
     */
