...
public class NativeAuthenticationProvider implements AuthenticationProvider<NativePacketPayload> {
     ...
     * handling initial ConnectionDB errors.
     *
     * @param user
     *            user name
     * @param pass
    ...
    public void connect(String user, String pass, String db) {
        ...
        /* First, negotiate SSL ConnectionDB */
     ...
     * ConnectionDB property and adds them to the map too.
     *
    ...
    private void loadAuthenticationPlugins() {
        ...
        // plugins from authenticationPluginClasses ConnectionDB parameter
     ...
     * @return null if plugin is not found or authentication plugin instance initialized with current ConnectionDB properties
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Check if given plugin requires confidentiality, but ConnectionDB is without SSL
     *
     * @param plugin
    ...
    /**
     * Performs an authentication handshake to authorize ConnectionDB to a given database as a given MySQL user.
     * This can happen upon initial ConnectionDB to the server, after receiving Auth Challenge Packet, or
     * at any moment during the ConnectionDB life-time via a Change User request.
     *
     ...
     *            this method is used during the initial ConnectionDB.
     *            Otherwise null.
     */
