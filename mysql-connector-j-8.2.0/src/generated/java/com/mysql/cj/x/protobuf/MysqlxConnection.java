...
public final class MysqlxConnection {
   ...
   * <pre>
   **
   *Get supported ConnectionDB capabilities and their current state.
   ...
   * <pre>
   **
   *Set ConnectionDB capabilities atomically.
   ...
   * <pre>
   **
   *Announce to the server that the client wants to close the ConnectionDB.
